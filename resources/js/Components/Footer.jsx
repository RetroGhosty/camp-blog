...
const Footer = ({marginX}) => {
  return (
    <>
      <div className={`flex flex-row items-center justify-center min-h-[200px] md:h-21 py-6 space-x-2 w-full bg-[#FF9E40] text-white sticky top-0 ${marginX}`}>
        <div className='grid grid-cols-1 gap-y-4 h-full w-full'>
          ...
          <ul className='w-full h-full flex flex-row items-center justify-center space-x-5 text-black'>
