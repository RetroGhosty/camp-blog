...
export default function Login({ status, canResetPassword, auth }) {
    ...
    return (
        <GuestLayout auth={auth}>
            <Head title="Log in" />
            <h2 className='w-full text-center text-3xl font-bold'>Login</h2>
            ...
            <div className='w-full flex flex-row items-center justify-center'>
                <Link
                    href={route('register')}
                    className="text-md font-semibold hover:text-[#F2844A] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 "
                >
                    Register
                </Link>
